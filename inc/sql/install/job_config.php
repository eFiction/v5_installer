...
('epub_version',				'archive_ebook', 6,				'', 											'select//2=2//3=3', 2),
('epub_domain',					'archive_ebook', 9,				'', 											'text//small', 1),
...
('advanced_editor', 			'settings_general', 8,			"{$fw['installerCFG.data.tinyMCE']}",			'select//{{@LN__yes}}=TRUE//{{@LN__no}}=FALSE', 1),
('allow_comment_news',			'settings_general', 9,			"{$fw['installerCFG.data.newscomments']}",		'select//{{@LN__yes}}=TRUE//{{@LN__no}}=FALSE', 1),
('allow_guest_comment_news',	'settings_general', 10,			'FALSE',										'select//{{@LN__yes}}=TRUE//{{@LN__no}}=FALSE', 1),
...
('shoutbox_entries',			'modules_shoutbox', 1,			'5',											'text//numeric', 1),
('shoutbox_guest',				'modules_shoutbox', 2,			'FALSE',										'select//{{@LN__yes}}=TRUE//{{@LN__no}}=FALSE', 1),
