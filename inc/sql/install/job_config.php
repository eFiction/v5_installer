...
('date_format_short',			'settings_datetime', 1,			"{$fw['installerCFG.data.dateformat']}", 		'text//small', 1),
('date_format_long',			'settings_datetime', 2,			"{$fw['installerCFG.data.dateformat']} {$fw['installerCFG.data.timeformat']}", 
																												'text//small', 1),
('time_format',					'settings_datetime', 3,			"H:i", 											'select//23:30=H:i//11:30 pm=h:i a', 1),
('date_format',					'settings_datetime', 4,			'd.m.Y',										'select//24.12.1997=d.m.Y//1997/24/12=Y/d/m', 1),
('monday_first_day',			'settings_datetime', 5,			'1',											'select//{{ @LN__Weekday, strtotime(''2016/02/01'') | format }}=1//{{ @LN__Weekday, strtotime(''2016/05/01'') | format }}=0', 1),
