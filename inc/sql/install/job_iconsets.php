...
(1, '#notes', 'requires \'@import url(https://use.fontawesome.com/releases/v5.14.0/css/all.css);\' in styles.css (See http://fortawesome.github.io/Font-Awesome/get-started/ )'),
(1, '#pattern', '<i class=\"@1@\"@T@></i>'),
(1, 'alert', 'fas fa-exclamation-triangle'),
(1, 'angle-double-down', 'fas fa-angle-double-down'),
(1, 'angle-double-left', 'fas fa-angle-double-left'),
(1, 'angle-double-right', 'fas fa-angle-double-right'),
(1, 'angle-double-up', 'fas fa-angle-double-up'),
(1, 'angle-down', 'fas fa-angle-down'),
(1, 'angle-left', 'fas fa-angle-left'),
(1, 'angle-right', 'fas fa-angle-right'),
(1, 'angle-up', 'fas fa-angle-up'),
...
(1, 'comment-off', 'far fa-comment'),
(1, 'comments', 'fas fa-comments'),
(1, 'comments-off', 'far fa-comments'),
(1, 'contest,award', 'fas fa-award'),
(1, 'crown', 'fas fa-crown'),
(1, 'document-new', 'far fa-file'),
(1, 'download', 'fas fa-download'),
(1, 'edit', 'fas fa-edit'),
(1, 'external-link', 'fas fa-external-link-alt'),
(1, 'far fa-thumbs-down', 'far fa-thumbs-down'),
...
(1, 'star,recommendation,feature', 'fas fa-star'),
(1, 'star-half,recommendation-upcoming,feature-upcoming', 'fas fa-star-half-alt'),
(1, 'star-off,recommendation-off,feature-off', 'far fa-star'),
(1, 'submissions', 'fas fa-cog'),
(1, 'tag', 'fas fa-tag'),
(1, 'tags', 'fas fa-tags'),
(1, 'thumbs-up', 'far fa-thumbs-up'),
(1, 'time', 'far fa-clock'),
