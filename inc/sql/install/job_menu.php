...
('Tags',			'archive', 4, 'archive/tags', '{ICON:tag}', 1, 64, NULL),
('Categories',		'archive', 5, 'archive/categories', '{ICON:blank}', 1, 64, NULL),
...
('Shoutbox',		'home', 5, 'home/shoutbox', '{ICON:blank}', 1, 64, '\$shoutbox == 1;'),
