...
('LN__AdminMenu_Layout', 3, 'settings/layout', '{ICON:layout}', 'settings', 1, 64, NULL),
('LN__AdminMenu_Registration', 2, 'settings/registration', '{ICON:register}', 'settings', 1, 128, NULL),
('LN__AdminMenu_Server', 1, 'settings/server', '{ICON:wrench}', 'settings', 1, 128, NULL),
('LN__AdminMenu_Shoutbox', 5, 'home/shoutbox', '{ICON:blank}', 'home', 1, 64, '\$shoutbox == 1;'),
('LN__AdminMenu_Modules', 4, 'home/modules', '{ICON:modules}', 'home', 1, 128, NULL),
('LN__AdminMenu_News', 3, 'home/news', '{ICON:news}', 'home', 1, 32, NULL),
('LN__AdminMenu_CustomPages', 2, 'home/custompages', '{ICON:text}', 'home', 1, 64, NULL),
('LN__AdminMenu_Manual', 1, 'home/manual', '{ICON:manual}', 'home', 1, 32, NULL),
('LN__AdminMenu_Stories', 5, 'stories', '{ICON:book}', NULL, 1, 64, NULL),
('LN__AdminMenu_Archive', 4, 'archive', '{ICON:archive}', NULL, 1, 64, NULL),
('LN__AdminMenu_Members', 3, 'members', '{ICON:member}', NULL, 1, 128, NULL),
('LN__AdminMenu_Settings', 2, 'settings', '{ICON:settings}', NULL, 1, 128, NULL),
('LN__AdminMenu_Home', 1, 'home', '{ICON:home}', NULL, 1, 32, NULL),
('LN__AdminMenu_Edit', 1, 'archive/tags/edit', '{ICON:tag}', 'archive/tags', 1, 64, NULL),
('LN__AdminMenu_Taggroups', 2, 'archive/tags/groups', '{ICON:tags}', 'archive/tags', 1, 128, NULL),
('LN__AdminMenu_Tagcloud', 3, 'archive/tags/cloud', '{ICON:cloud}', 'archive/tags', 1, 128, NULL),
('LN__AdminMenu_Categories', 4, 'archive/categories', '{ICON:blank}', 'archive', 1, 64, NULL),
('LN__AdminMenu_Pending', 1, 'stories/pending', '{ICON:waiting}', 'stories', 1, 32, NULL),
('LN__AdminMenu_Edit', 2, 'stories/edit', '{ICON:edit}', 'stories', 1, 64, NULL),
('LN__AdminMenu_Add', 3, 'stories/add', '{ICON:document-new}', 'stories', 1, 64, NULL),
('LN__AdminMenu_Settings', 1, 'archive/featured', '{ICON:blank}', 'archive/featured', 1, 64, NULL),
('LN__AdminMenu_Current', 2, 'archive/featured/select=current', '{ICON:blank}', 'archive/featured', 1, 64, NULL),
('LN__AdminMenu_Past', 4, 'archive/featured/select=past', '{ICON:blank}', 'archive/featured', 1, 64, NULL),
('LN__AdminMenu_Future', 3, 'archive/featured/select=future', '{ICON:blank}', 'archive/featured', 1, 64, NULL),
('LN__AdminMenu_Characters', 2, 'archive/characters', '{ICON:members}', 'archive', 1, 64, NULL);--NOTEAdmin panel menu
--SPLIT--
