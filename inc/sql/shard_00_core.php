...
('page_mail', "{$fw['installerCFG.data.siteemail']}", 'Webmaster e-mail address', 'general_settings_site', 2, 'text//', 1, 1),
('page_slogan', "{$fw['installerCFG.data.slogan']}", 'Site slogan', 'general_settings_site', 3, 'text//', 1, 1),
('page_title', "{$fw['installerCFG.data.sitename']}", 'Website title', 'general_settings_site', 1, 'text//', 1, 1),
('page_title_add', 'path', 'Show page path or slogan in title', 'general_settings_site', 4, 'select//__path=path//__slogan=slogan', 1, 1),
...
('shoutbox_entries', '5', 'Number of shoutbox items to display', 'general_settings_site', 7, 'text//numeric', 1, 1),
('shoutbox_guest', 'TRUE', 'Allow guest posts in shoutbox', 'general_settings_site', 8, 'select//__yes=TRUE//__no=FALSE', 1, 1),
...
('LN__AdminMenu_Groupings', 3, 'archive/groupings', '{ICON:blank}', 'archive', 1, 1, NULL),
